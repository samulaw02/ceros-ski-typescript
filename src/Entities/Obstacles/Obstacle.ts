...
/**
 * The different types of obstacles that can be jumped.
 */
const JUMPABLE_OBSTACLE: IMAGE_NAMES[] = [
    IMAGE_NAMES.ROCK1,
    IMAGE_NAMES.ROCK2
]
...
export class Obstacle extends Entity {
    ...
    /**
     * Check if obstacle can be jumped.
     */
    isJumpable(): boolean {
        return JUMPABLE_OBSTACLE.includes(this.obstacleType);
    } 
